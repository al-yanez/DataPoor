#######################################################################
#       Modelo DB-SRA: Depletion-Based Stock Reduction Analysis:      #
#       A catch-based method for determining sustainable yields       #
#       for data-poor fish stocks. Fisheries Research 110:331-341     #
#######################################################################
# This method make reference to Dick E. J. and A. MacCall. 2011.
# Aplicacion a las capturas de raya volantin, UP + SUP
#
